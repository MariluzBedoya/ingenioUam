 ...
 */
@Entity
@Table(name = "tipoPregunta", catalog = "ingenioUam", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TipoPregunta.findAll", query = "SELECT t FROM TipoPregunta t"),
    @NamedQuery(name = "TipoPregunta.findById", query = "SELECT t FROM TipoPregunta t WHERE t.id = :id"),
...
public class TipoPregunta implements Serializable {
    ...
    public TipoPregunta(Integer id) {
        this.id = id;
    }
